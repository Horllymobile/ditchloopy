...
class InvitationRepository(
    ...
    val allDailyCheckIns: Flow<List<DailyCheckIn>> = dailyCheckInDao.getAllCheckIns()

    suspend fun insertDailyCheckIn(checkIn: DailyCheckIn) {
        dailyCheckInDao.insertCheckIn(checkIn)
    }

    suspend fun deleteDailyCheckInById(id: Int) {
        dailyCheckInDao.deleteCheckInById(id)
    }
